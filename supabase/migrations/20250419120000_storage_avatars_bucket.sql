-- Public bucket for profile images (used by OnboardingWizard, MediaEditScreen, api.uploadProfilePicture)
-- Apply: supabase db push   OR run this SQL in Supabase Dashboard → SQL Editor
...
-- Objects live at paths like: {user_id}/{timestamp}.jpg
