    ...
    <button
      ...
      className={`mb-1 w-full rounded-md border-l-2 px-1.5 py-0.5 text-left transition-opacity hover:opacity-80 ${
        isMe
          ...
          : 'border-orange-500/80 bg-black/[0.04] dark:border-orange-400/50 dark:bg-black/30'
      }`}
    >
      <p className={`text-[10px] font-medium leading-tight ${isMe ? 'text-white/90 dark:text-[#c5d4e3]' : 'text-orange-600 dark:text-orange-400/80'}`}>
        {quote.senderLabel}
      </p>
