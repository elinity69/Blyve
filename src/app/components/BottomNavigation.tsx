...
export function BottomNavigation({ activeTab, onTabChange }: BottomNavigationProps) {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 right-0 z-[60] bg-white dark:bg-black md:bg-white/80 md:dark:bg-black/80 md:backdrop-blur-md border-t border-gray-200 dark:border-white/5 md:shadow-lg"
